...
3. **Run the strawberry test**: At the end of the colab notebook, run the function *strawberry_test*. It outputs the models response in the required format with its counting of the letter r.
