...
class DMPMotionGenerator:
    ...
    def learn_from_rosbag(self, bag_path, joint_topic, dt=None, n_weights=10):
        ...
        np.save(f"/root/catkin_ws/src/my_scripts_rl/recordings/rec/pick_y.npy", Y)
        if dt is None:
            dt = 1/self.frequency
...
if __name__ == "__main__":
    ...
    bag_path = '/root/catkin_ws/src/my_scripts_rl/recordings/rec/pick.bag'
    ...
    dmp_gen.save_dmp('/root/catkin_ws/recordings/dmp/learned_pick_motion.pkl')
    dmp_gen.load_dmp('/root/catkin_ws/recordings/dmp/learned_pick_motion.pkl')
    ...
    #new_start[:3] = np.array([0.1, 0.0, 0.2])
    new_goal[:3] += np.array([0.0, 0.0, -0.01])  # Modify position
